...
Tải installer từ [public GitHub Releases](https://github.com/anhtahaylove/affiliate-report/releases), đối chiếu `SHA256SUMS.txt`, rồi chạy `AffiliateReportSetup-v2.0.28.exe`.
...
2. Mở PowerShell tại thư mục tải xuống và kiểm tra hash nếu cần:
   ...
   ```powershell
   Get-FileHash .\AffiliateReportSetup-v2.0.28.exe -Algorithm SHA256
   ```
...
- `artifacts\installer\AffiliateReportSetup-v2.0.28.exe`
