...
Tải installer từ [public GitHub Releases](https://github.com/anhtahaylove/tiktok-affiliate-report-updates/releases), đối chiếu `SHA256SUMS.txt`, rồi chạy `TikTokAffiliateReportSetup-v2.0.1.exe`.
...
2. Mở PowerShell tại thư mục tải xuống và kiểm tra hash nếu cần:
   ...
   ```powershell
   Get-FileHash .\TikTokAffiliateReportSetup-v2.0.1.exe -Algorithm SHA256
   ```
...
- `artifacts\installer\TikTokAffiliateReportSetup-v2.0.1.exe`
